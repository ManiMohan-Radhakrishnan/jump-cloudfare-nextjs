...
export const lootDomainSlugApi = () => appAxios.get(`/domain_extensions`);

export const lootDomainFilterApi = ({ domain_name, domain_extension_slug }) =>
  appAxios.get(
    `/domains/search?keyword=${domain_name}&domain_extension_slug=${domain_extension_slug}`
  );
export const lootDomainSearchApi = ({ domain_name }) =>
  appAxios.get(`/domains/search?keyword=${domain_name}`);

export const getBnsDropPriceBreakup = ({ request: domain_purchases }) =>
  appAxios.post(`/domain_purchases/splitup`, { domain_purchases });

export const getBnsBuyApi = ({ request: domain_purchases }) =>
  appAxios.post(`/domain_purchases`, { domain_purchases });
