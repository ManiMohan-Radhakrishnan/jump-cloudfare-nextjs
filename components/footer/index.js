            ...
            <>
              ...
              >
                <Dropdown.Toggle
                  ...
                  // as={RoleDropdown}
                >
                  <Image alt="drop icon" src={dropsIcon} />
                  <span>Drops</span>
                </Dropdown.Toggle>
                ...
                <Dropdown.Menu align="start" drop="up">
                  ...
                  <Dropdown.Item
                    onClick={() => router.push("/drop/raddx-car-nfts")}
                  >
              ...
              >
                ...
                >
                  ...
                  >
                    <Image alt="rental icon" src={rentalIcon} />
                    <span>Rental</span>
                  </div>
                </Dropdown.Toggle>
              </Dropdown>
              ...
              >
                ...
                >
                  <div
                    onClick={() => {
                      router.push("/mcl-game");
                    }}
                  >
                    <Image alt="game icon" src={mclGameIcon} />
                    <span>Game</span>
                  </div>
                </Dropdown.Toggle>
              </Dropdown>
              <Dropdown drop="up" autoClose={["inside", "outside"]}>
                <Dropdown.Toggle
                  ...
                  // as={RoleDropdown}
                >
                  <Image alt="more icon" src={moreIcon} />
                  <span>More</span>
                </Dropdown.Toggle>
                ...
                <Dropdown.Menu align="start" drop="center">
                  ...
                  <Dropdown.Item
                    onClick={() =>
                      openWindowBlank("https://discord.com/invite/QU2vNXgqNe")
                    }
                  >
                    Discord
                  </Dropdown.Item>
      ...
      <div id="footer" className={style["footer"]}>
        <div id="fmenu1" className={style["fmenu1"]}>
          <div className={`${style["submenu"]} ${style["first-box"]}`}>
            <Link target="_self" href="/" prefetch={false}>
              <a>
                <Image
                  layout="responsive"
                  height="100"
