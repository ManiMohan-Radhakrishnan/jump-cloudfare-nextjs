      ...
      <div className="container">
        ...
        <div className={style["news_box"]}>
          ...
          <div className={style["news_img"]}>
            ...
            >
              <a target="_blank">
                <Image src={images.mint} alt="Mint" height={100} width={100} />
              </a>
            </Link>
          </div>
          <div className={style["news_img"]}>
            ...
            >
              <a target="_blank">
                <Image src={images.out} alt="Out " height={100} width={100} />
              </a>
            </Link>
          </div>
          ...
          <div className={style["news_img"]}>
            ...
            >
              <a target="_blank">
                <Image src={images.bw} alt="bw" height={100} width={100} />
              </a>
            </Link>
          </div>
          <div className={style["news_img"]}>
            ...
            >
              <a target="_blank">
                <Image src={images.et} alt="et" height={100} width={100} />
              </a>
            </Link>
          </div>
          ...
          <div className={style["news_img"]}>
            ...
            >
              <a target="_blank">
                <Image src={images.cnbc} alt="cnbc" height={100} width={100} />
              </a>
            </Link>
          </div>
          <div className={style["news_img"]}>
            ...
            >
              <a target="_blank">
                <Image src={images.n18} alt="n18" height={100} width={100} />
              </a>
            </Link>
          </div>
          <div className={style["news_img"]}>
            ...
            >
              <a target="_blank">
                <Image src={images.tfe} alt="tfe" height={100} width={100} />
              </a>
            </Link>
          </div>
        </div>
