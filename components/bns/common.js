  ...
  },
  {
    ...
    info: (
      <>
        ...
        (Rookie, Rare, Epic, Legendary). Fusing two batters produces a new MCL
        Premier batter. Fusing two bowlers produces a new MCL Premier bowler.
        Fusing an MCL batter with an MCL bowler will produce either an MCL
        Premier batter or bowler at random. The Fusor is burned in the process.
      </>
    ),
  },
];
