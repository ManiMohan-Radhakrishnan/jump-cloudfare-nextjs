          ...
          <div className="col-12">
            ...
            <div className={`${style["content-block"]}`}>
              <p>
                ...
                batters produces a new MCL Premier batter. Fusing two bowlers
                produces a new MCL Premier bowler. Fusing an MCL batter with an
                MCL bowler will produce either an MCL Premier batter or bowler
                at random. The Fusor is burned in the process.
              </p>
              <p>
                Depending on that category (Rookie, Rare, Epic, Legendary),
                you’ll need an appropriate category Fusor. E.g. if you fuse a
                Rookie and a Rare NFT using a Rare Fusor, the new MCL Premier
