...
import { leaderBoardListApi, tournamentsApi } from "../../utils/base-methods";
                    ...
                    typeof leaderBoardList === "undefined" ? (
                      ...
                      <>
                        ...
                        <button
                          ...
                          onClick={() =>
                            router.push(
                              "/nft-marketplace/contest/?winners=true"
                            )
                          }
                        >
                          View more
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-12 col-sm-6">
                <div
                  className={`${style["live-upcoming-tour"]} ${style["btnblock-tour"]} ${style["border-right"]} mb-3`}
                >
              ...
              <div className="col-12 col-sm-6">
                <div
                  className={`${style["live-upcoming-tour"]} ${style["btnblock-tour"]}  mb-3`}
                >
