          ...
          <div className="col-12">
            <article className={style["release-notes-card-box"]}>
                ...
                <div className="row justify-content-start">
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_1} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_2} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_3} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_4} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_5} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_6} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_7} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_8} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_9} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_10} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_11} />
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className={style["contest-card"]}>
                      <img alt="" src={images?.santa_reward_12} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <span className={style["contest-link"]}>
                <Link href="/supersanta-treasurebox-contest-terms-and-conditions">
