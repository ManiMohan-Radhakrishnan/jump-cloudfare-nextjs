...
import {
  cryptoBatDropLiveStatus,
  getAndroidAPK,
  getWindowsEXE,
  isUserLoggedIn,
  mclFusorsLootStatus,
  mclPlayPassDropLiveStatus,
  mclPlayShotsDropLiveStatus,
  walletUpdate,
...
const ENABLE_CREATOR_APPLICATION = false;
...
const Header = ({
  ...
  const isPlayPassLive = useSelector(mclPlayPassDropLiveStatus);
  const isShotsDropLive = useSelector(mclPlayShotsDropLiveStatus);
  const isFusorDropLive = useSelector(mclFusorsLootStatus);
  ...
  useEffect(() => {
    dispatch(downloadMCLGame("android"));
    dispatch(downloadMCLGame("windows"));
    ...
    return (
      ...
      >
        ...
        {/* <span className="new-badge">
          ...
          isShotsDropLive === LOOT_STATUS?.PRE_BOOK ||
          isFusorDropLive === LOOT_STATUS?.DROP
            ? "live"
            : "new"}
        </span> */}
      </Nav.Link>
              ...
              <div className={style["left-menu"]}>
                <div className={style["top-header-content"]}>
                  <p>
                    {" "}
                    <FaInfoCircle />
                    For a limited time, we have slashed our royalty fee to 0%
                    and service fee to almost ZERO!
                  </p>
                </div>
              </div>
              {
                <>
                  <div className={style["right-menu"]} onClick={handleClose}>
            ...
            <>
              <Nav className="d-flex me-0 ms-auto">
                ...
                <Dropdown autoClose={["inside", "outside"]} className="me-0">
                  ...
                  <Dropdown.Menu align="end">
                    ...
                    >
                      MCL Fusor NFTs{" "}
                      {/* {isFusorDropLive !== LOOT_STATUS?.SOLD_OUT && (
                ...
                {ENABLE_CREATOR_APPLICATION && (
                  <Nav.Link
                    ...
                    role="button"
                    className={"pre-btn"}
                    onClick={() => router.push(creator_path)}
                  >
                    List your NFTs
                    <sup className={style["drop-sup"]}>New</sup>
                  </Nav.Link>
                ...
                <Nav.Link
                  ...
                  role="button"
                  className={"pre-btn"}
                  onClick={() => router.push(rental_path)}
                >
                ...
                <Nav.Link
                  ...
                  onClick={() => router.push(referral_path)}
                >
                  <span className={style["beta-container"]}>Refer & Earn</span>
                </Nav.Link>
                <Nav.Link
                  id="drop_outer"
                  role="button"
              ...
              <Dropdown autoClose={["inside", "outside"]}>
                ...
                <Dropdown.Menu align="end" className="side-menu">
                  ...
                  <Dropdown.Item onClick={() => router.push(fusor_path)}>
                    <span
                    // className={"blink_contest"}
                    >
                      MCL Fusor NFTs
                  ...
                  {ENABLE_CREATOR_APPLICATION && (
                    <Dropdown.Item href={creator_path}>
                  ...
                  <Dropdown.Item href={rental_path}>
                    <span className={style["beta-container"]}>
                      <span className={style["beta-tag"]}>Beta</span> Rental{" "}
                    </span>
                  </Dropdown.Item>
                  <Dropdown.Item href={bns_path}>
                    <span className={style["beta-container"]}>
                      <span className={style["beta-tag"]}>Beta</span> BNS{" "}
                    </span>
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => router.push("/mcl-game")}>
                    <span className={style["beta-container"]}>
                  ...
                  <Dropdown.Item onClick={() => router.push(referral_path)}>
                    <span className={style["beta-container"]}>
                      Refer & Earn
